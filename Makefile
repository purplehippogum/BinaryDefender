...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Apr 26 15:21:33 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/game_vegaperk1.0.0/ && $(COPY_FILE) --parents abstract_object.h basic_bullet.h enemy.h game_object.h gameplay.h health_bar.h mainwindow.h play_area.h player.h score.h .tmp/game_vegaperk1.0.0/ && $(COPY_FILE) --parents abstract_object.cpp basic_bullet.cpp enemy.cpp game.cpp game_object.cpp gameplay.cpp health_bar.cpp mainwindow.cpp play_area.cpp player.cpp score.cpp .tmp/game_vegaperk1.0.0/ && (cd `dirname .tmp/game_vegaperk1.0.0` && $(TAR) game_vegaperk1.0.0.tar game_vegaperk1.0.0 && $(COMPRESS) game_vegaperk1.0.0.tar) && $(MOVE) `dirname .tmp/game_vegaperk1.0.0`/game_vegaperk1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/game_vegaperk1.0.0
