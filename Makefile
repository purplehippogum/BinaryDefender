...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Apr 27 13:31:20 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/game_vegaperk1.0.0/ && $(COPY_FILE) --parents abstract_object.h arrow_bullet.h basic_bullet.h bomb.h enemy.h game_object.h gameplay.h health_bar.h mainwindow.h pause_button.h play_area.h player.h score.h .tmp/game_vegaperk1.0.0/ && $(COPY_FILE) --parents abstract_object.cpp arrow_bullet.cpp basic_bullet.cpp bomb.cpp enemy.cpp game.cpp game_object.cpp gameplay.cpp health_bar.cpp mainwindow.cpp pause_button.cpp play_area.cpp player.cpp score.cpp .tmp/game_vegaperk1.0.0/ && (cd `dirname .tmp/game_vegaperk1.0.0` && $(TAR) game_vegaperk1.0.0.tar game_vegaperk1.0.0 && $(COMPRESS) game_vegaperk1.0.0.tar) && $(MOVE) `dirname .tmp/game_vegaperk1.0.0`/game_vegaperk1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/game_vegaperk1.0.0
...
pause_button.o: pause_button.cpp pause_button.h \
		abstract_object.h \
		mainwindow.h \
		player.h \
		basic_bullet.h \
		...
		game_object.h \
		health_bar.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pause_button.o pause_button.cpp
